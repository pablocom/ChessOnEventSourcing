...
public static class EventDeserializer
{
    ...
    public static Event Deserialize(EventDescriptor eventDescriptor)
    {
        ...
        var deserializedEvent = JsonSerializer.Deserialize(eventDescriptor.EventData, eventType) as Event;
